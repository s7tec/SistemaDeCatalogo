...
public class CatalogoCelulares {
        ...
        private List<CelularesInfo> celulares;

        public CatalogoCelulares(){
            celulares = new ArrayList<>();
        }

        public void adicionarCelular(CelularesInfo celular){
            celulares.add(celular);
        }
        public List<CelularesInfo> listarCelulares(){
            return new ArrayList<>(celulares);
        }

        public void removerCelular(CelularesInfo celularesInfo){
